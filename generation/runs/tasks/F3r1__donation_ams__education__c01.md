# BLIND PREDICTION TASK — F3r1__donation_ams__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r1__donation_ams__education__c01.json
...
```json
{
  "task_id": "F3r1__donation_ams__education__c01",
  ...
  "shifts": {
    "L1": {"donation": {"C05": 0.15, "C12": 0.15, "C16": 0.15, ...}},
    "L2": {"donation": {"C05": 0.15, "C12": 0.15, "C16": 0.15, ...}},
    ...
  }
}
```
...
* Values are dollars, 0 to 10, two decimals. This is a mean donation out of a
  real $10 bonus. Shifts are signed and control + shift must stay in range.
