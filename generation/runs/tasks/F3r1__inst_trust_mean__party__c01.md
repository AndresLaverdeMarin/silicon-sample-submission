# BLIND PREDICTION TASK — F3r1__inst_trust_mean__party__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r1__inst_trust_mean__party__c01.json
...
```json
{
  "task_id": "F3r1__inst_trust_mean__party__c01",
