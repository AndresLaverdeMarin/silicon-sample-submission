# BLIND PREDICTION TASK — F3r2__belief_post__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__belief_post__education__c01.json
...
```json
{
  "task_id": "F3r2__belief_post__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C04>",
  "control": {
    "L1": {"belief_post_1": 62.5},
    "L2": {"belief_post_1": 62.5},
    ...
  },
  "shifts": {
    "L1": {"belief_post_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    "L2": {"belief_post_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
