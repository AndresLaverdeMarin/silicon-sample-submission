# BLIND PREDICTION TASK — F2r1__trust_post__education__c01
...
The single item behind the scored outcome `trust_post`. Predict each one
separately: they are
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__trust_post__education__c01.json
...
```json
{
  "task_id": "F2r1__trust_post__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C15>",
  "values": {
    "L1": {"trust_post_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"trust_post_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
