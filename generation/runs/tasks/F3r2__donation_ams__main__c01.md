# BLIND PREDICTION TASK — F3r2__donation_ams__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__donation_ams__main__c01.json
...
```json
{
  "task_id": "F3r2__donation_ams__main__c01",
  ...
  "shifts": {
    "G0": {"donation": {"C05": 0.15, "C12": 0.15, "C16": 0.15, ...}},
    ...
  }
}
```
