# BLIND PREDICTION TASK — F1r1__trust_multidimensional__gender__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r1__trust_multidimensional__gender__c02.json
...
```json
{
  "task_id": "F1r1__trust_multidimensional__gender__c02",
