# BLIND PREDICTION TASK — F2r2__behavior_mean__education__c02
...
1 of the 6 items behind the scored outcome `behavior_mean`. Predict each one
separately: they are
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__behavior_mean__education__c02.json
...
```json
{
  "task_id": "F2r2__behavior_mean__education__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C08>",
  "values": {
    "L1": {"individual_donate_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"individual_donate_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
