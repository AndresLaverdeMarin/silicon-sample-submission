# BLIND PREDICTION TASK — F2r1__behavior_mean__education__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__behavior_mean__education__c02.json
...
```json
{
  "task_id": "F2r1__behavior_mean__education__c02",
