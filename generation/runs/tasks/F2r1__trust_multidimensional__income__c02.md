# BLIND PREDICTION TASK — F2r1__trust_multidimensional__income__c02
...
6 of the 12 items behind the scored outcome `trust_multidimensional`. Predict
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__trust_multidimensional__income__c02.json
...
```json
{
  "task_id": "F2r1__trust_multidimensional__income__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C08>",
  "values": {
    "L1": {"trust_concerned_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_improve_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"trust_concerned_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_improve_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
