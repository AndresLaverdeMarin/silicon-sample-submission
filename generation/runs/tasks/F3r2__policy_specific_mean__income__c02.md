# BLIND PREDICTION TASK — F3r2__policy_specific_mean__income__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__policy_specific_mean__income__c02.json
...
```json
{
  "task_id": "F3r2__policy_specific_mean__income__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C13>",
  "control": {
    "L1": {"policy_specific_7_1": 62.5},
    "L2": {"policy_specific_7_1": 62.5},
    ...
  },
  "shifts": {
    "L1": {"policy_specific_7_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    "L2": {"policy_specific_7_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
