# BLIND PREDICTION TASK — F2r1__donation_ams__age_band__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__donation_ams__age_band__c01.json
...
```json
{
  "task_id": "F2r1__donation_ams__age_band__c01",
