# BLIND PREDICTION TASK — F2r1__policy_specific_mean__education__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__policy_specific_mean__education__c02.json
...
```json
{
  "task_id": "F2r1__policy_specific_mean__education__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C09>",
  "values": {
...
* `read_check` — the first four words of the C09 text, copied exactly from the
