# BLIND PREDICTION TASK — F1r1__newsletter_signup__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r1__newsletter_signup__education__c01.json
...
```json
{
  "task_id": "F1r1__newsletter_signup__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C04>",
  "values": {
    "L1": {"newsletter": {"C00": 12.5, "C01": 12.5, "C02": 12.5, ...}},
    "L2": {"newsletter": {"C00": 12.5, "C01": 12.5, "C02": 12.5, ...}},
    ...
  }
}
```
