# BLIND PREDICTION TASK — F2r2__trust_multidimensional__main__c01
...
All 12 items behind the scored outcome `trust_multidimensional`. Predict each
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__trust_multidimensional__main__c01.json
...
```json
{
  "task_id": "F2r2__trust_multidimensional__main__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C03>",
  "values": {
    "G0": {"trust_competent_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_intelligent_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
