# BLIND PREDICTION TASK — F3r1__policy_specific_mean__income__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r1__policy_specific_mean__income__c02.json
...
```json
{
  "task_id": "F3r1__policy_specific_mean__income__c02",
