# BLIND PREDICTION TASK — F2r1__trust_multidimensional__age_band__c01
...
7 of the 12 items behind the scored outcome `trust_multidimensional`. Predict
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__trust_multidimensional__age_band__c01.json
...
```json
{
  "task_id": "F2r1__trust_multidimensional__age_band__c01",
