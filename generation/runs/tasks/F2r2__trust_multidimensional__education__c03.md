# BLIND PREDICTION TASK — F2r2__trust_multidimensional__education__c03
...
2 of the 12 items behind the scored outcome `trust_multidimensional`. Predict
...
asked as separate survey questions.
  ...
  trust_transparent_1
      ...
      scale: 0 = Very unwilling … 100 = Very willing
  ...
  trust_attention_1
      ...
      scale: 0 = Very little attention … 100 = A great deal of attention
      give:  mean of the 0-100 slider (1 decimal)

(This is part 3 of 3 for this outcome and group set. The other items are asked
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__trust_multidimensional__education__c03.json
...
```json
{
  "task_id": "F2r2__trust_multidimensional__education__c03",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C12>",
  "values": {
    "L1": {"trust_transparent_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_attention_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"trust_transparent_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_attention_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
...
* `read_check` — the first four words of the C12 text, copied exactly from the
