# BLIND PREDICTION TASK — F2r2__trust_multidimensional__age_band__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__trust_multidimensional__age_band__c02.json
...
```json
{
  "task_id": "F2r2__trust_multidimensional__age_band__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C07>",
  "values": {
    "L1": {"trust_improve_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_considerate_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"trust_improve_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_considerate_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
