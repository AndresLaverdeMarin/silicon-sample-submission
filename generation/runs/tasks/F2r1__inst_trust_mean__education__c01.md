# BLIND PREDICTION TASK — F2r1__inst_trust_mean__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__inst_trust_mean__education__c01.json
...
```json
{
  "task_id": "F2r1__inst_trust_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C11>",
  "values": {
...
* `read_check` — the first four words of the C11 text, copied exactly from the
