# BLIND PREDICTION TASK — F1r2__trust_multidimensional__education__c03
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r2__trust_multidimensional__education__c03.json
...
```json
{
  "task_id": "F1r2__trust_multidimensional__education__c03",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C16>",
  "values": {
    "L1": {"trust_transparent_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}, "trust_attention_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    "L2": {"trust_transparent_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}, "trust_attention_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    ...
  }
}
```
