# BLIND PREDICTION TASK — F2r2__behavior_mean__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__behavior_mean__education__c01.json
...
```json
{
  "task_id": "F2r2__behavior_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C07>",
  "values": {
...
* `read_check` — the first four words of the C07 text, copied exactly from the
