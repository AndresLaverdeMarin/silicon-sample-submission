# BLIND PREDICTION TASK — F2r1__policy_specific_mean__education__c01
...
5 of the 7 items behind the scored outcome `policy_specific_mean`. Predict
each one separately: they are
asked as separate survey questions.

  policy_specific_1_1
      How much do you support or oppose: — Raising taxes on fossil fuels (e.g., gas, oil, coal)
      scale: 0 = Strongly oppose … 100 = Strongly support
      give:  mean of the 0-100 slider (1 decimal)
  policy_specific_2_1
      How much do you support or oppose: — Expanding infrastructure for public transportation
      scale: 0 = Strongly oppose … 100 = Strongly support
      give:  mean of the 0-100 slider (1 decimal)
  policy_specific_3_1
      How much do you support or oppose: — Increasing the use of sustainable energy such as wind and solar energy
      scale: 0 = Strongly oppose … 100 = Strongly support
      give:  mean of the 0-100 slider (1 decimal)
  policy_specific_4_1
      How much do you support or oppose: — Protecting forested and land areas
      scale: 0 = Strongly oppose … 100 = Strongly support
      give:  mean of the 0-100 slider (1 decimal)
  policy_specific_5_1
      How much do you support or oppose: — Increasing taxes on carbon-intensive foods (e.g., beef and dairy products)
      scale: 0 = Strongly oppose … 100 = Strongly support
      give:  mean of the 0-100 slider (1 decimal)
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__policy_specific_mean__education__c01.json
...
```json
{
  "task_id": "F2r1__policy_specific_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C08>",
  "values": {
    "L1": {"policy_specific_1_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "policy_specific_2_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"policy_specific_1_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "policy_specific_2_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
...
* `read_check` — the first four words of the C08 text, copied exactly from the
