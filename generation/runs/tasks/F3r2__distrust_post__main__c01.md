# BLIND PREDICTION TASK — F3r2__distrust_post__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__distrust_post__main__c01.json
...
```json
{
  "task_id": "F3r2__distrust_post__main__c01",
  ...
  "shifts": {
    "G0": {"distrust_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
