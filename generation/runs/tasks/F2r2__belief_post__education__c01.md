# BLIND PREDICTION TASK — F2r2__belief_post__education__c01
...
The single item behind the scored outcome `belief_post`. Predict each one
separately: they are
asked as separate survey questions.
  ...
  belief_post_1
      ...
      scale: 0 = not at all accurate … 100 = extremely accurate
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__belief_post__education__c01.json
...
```json
{
  "task_id": "F2r2__belief_post__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C08>",
  "values": {
    "L1": {"belief_post_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"belief_post_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
