# BLIND PREDICTION TASK — F1r2__policy_specific_mean__education__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r2__policy_specific_mean__education__c02.json
...
```json
{
  "task_id": "F1r2__policy_specific_mean__education__c02",
