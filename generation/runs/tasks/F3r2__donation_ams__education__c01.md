# BLIND PREDICTION TASK — F3r2__donation_ams__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__donation_ams__education__c01.json
...
```json
{
  "task_id": "F3r2__donation_ams__education__c01",
