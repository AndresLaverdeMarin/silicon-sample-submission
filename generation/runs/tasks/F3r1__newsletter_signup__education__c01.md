# BLIND PREDICTION TASK — F3r1__newsletter_signup__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r1__newsletter_signup__education__c01.json
...
```json
{
  "task_id": "F3r1__newsletter_signup__education__c01",
  ...
  "shifts": {
    "L1": {"newsletter": {"C05": 1.8, "C12": 1.8, "C16": 1.8, ...}},
    "L2": {"newsletter": {"C05": 1.8, "C12": 1.8, "C16": 1.8, ...}},
    ...
  }
}
```
...
* Values are percentages, 0 to 100, one decimal: the share of the group that
  signed up. Shifts are signed and control + shift must stay in range.
