# BLIND PREDICTION TASK — F1r2__trust_multidimensional__race__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r2__trust_multidimensional__race__c02.json
...
```json
{
  "task_id": "F1r2__trust_multidimensional__race__c02",
