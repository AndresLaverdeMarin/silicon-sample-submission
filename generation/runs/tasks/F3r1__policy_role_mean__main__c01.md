# BLIND PREDICTION TASK — F3r1__policy_role_mean__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r1__policy_role_mean__main__c01.json
...
```json
{
  "task_id": "F3r1__policy_role_mean__main__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C12>",
  "control": {
    "G0": {"policy_1_1": 62.5, "policy_2_1": 62.5},
    ...
  },
  "shifts": {
    "G0": {"policy_1_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "policy_2_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
