# BLIND PREDICTION TASK — F2r2__policy_role_mean__education__c01
...
All 4 items behind the scored outcome `policy_role_mean`. Predict each one
separately: they are
asked as separate survey questions.

  policy_1_1
      To what extent do you agree or disagree: — Climate scientists should work closely with policy makers to integrate scientific results into policy-making.
      scale: 0 = Strongly disagree … 100 = Strongly agree
      give:  mean of the 0-100 slider (1 decimal)
  policy_2_1
      To what extent do you agree or disagree: — Climate scientists should actively advocate for specific policies.
      scale: 0 = Strongly disagree … 100 = Strongly agree
      give:  mean of the 0-100 slider (1 decimal)
  policy_3_1
      To what extent do you agree or disagree: — Climate scientists should communicate their findings to policy makers.
      scale: 0 = Strongly disagree … 100 = Strongly agree
      give:  mean of the 0-100 slider (1 decimal)
  policy_4_1
      To what extent do you agree or disagree: — Climate scientists should be more involved in the policy-making process.
      scale: 0 = Strongly disagree … 100 = Strongly agree
      give:  mean of the 0-100 slider (1 decimal)
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__policy_role_mean__education__c01.json
...
```json
{
  "task_id": "F2r2__policy_role_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C10>",
  "values": {
    "L1": {"policy_1_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "policy_2_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"policy_1_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "policy_2_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
...
When the file is written, reply with only the number of values it holds (408).
