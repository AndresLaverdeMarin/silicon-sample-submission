# BLIND PREDICTION TASK — F2r1__policy_specific_mean__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__policy_specific_mean__main__c01.json
...
```json
{
  "task_id": "F2r1__policy_specific_mean__main__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C03>",
  "values": {
    "G0": {"policy_specific_1_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "policy_specific_2_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
...
When the file is written, reply with only the number of values it holds (119).
