# BLIND PREDICTION TASK — F3r2__funding_perceptions__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__funding_perceptions__education__c01.json
...
```json
{
  "task_id": "F3r2__funding_perceptions__education__c01",
  ...
  "shifts": {
    "L1": {"funding_5": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    "L2": {"funding_5": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
