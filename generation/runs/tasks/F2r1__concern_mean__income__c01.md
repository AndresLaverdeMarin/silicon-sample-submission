# BLIND PREDICTION TASK — F2r1__concern_mean__income__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__concern_mean__income__c01.json
...
```json
{
  "task_id": "F2r1__concern_mean__income__c01",
...
When the file is written, reply with only the number of values it holds (255).
