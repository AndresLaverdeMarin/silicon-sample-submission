# BLIND PREDICTION TASK — F1r2__trust_multidimensional__party__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r2__trust_multidimensional__party__c02.json
...
```json
{
  "task_id": "F1r2__trust_multidimensional__party__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C04>",
  "values": {
    "L1": {"trust_improve_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}, "trust_considerate_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    "L2": {"trust_improve_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}, "trust_considerate_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    ...
  }
}
```
