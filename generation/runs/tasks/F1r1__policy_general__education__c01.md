# BLIND PREDICTION TASK — F1r1__policy_general__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r1__policy_general__education__c01.json
...
```json
{
  "task_id": "F1r1__policy_general__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C04>",
  "values": {
    "L1": {"policy_general_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    "L2": {"policy_general_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    ...
  }
}
```
