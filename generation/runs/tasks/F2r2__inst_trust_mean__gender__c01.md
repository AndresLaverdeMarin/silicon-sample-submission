# BLIND PREDICTION TASK — F2r2__inst_trust_mean__gender__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__inst_trust_mean__gender__c01.json
...
```json
{
  "task_id": "F2r2__inst_trust_mean__gender__c01",
