# BLIND PREDICTION TASK — F2r2__inst_trust_mean__education__c01
...
All 5 items behind the scored outcome `inst_trust_mean`. Predict each one
separately: they are
asked as separate survey questions.

  inst_trust_epa_1
      How much do you trust the following institutions? — Environmental Protection Agency (EPA)
      scale: 0 = not at all … 100 = very strongly
      give:  mean of the 0-100 slider (1 decimal)
  inst_trust_nasa_1
      How much do you trust the following institutions? — National Aeronautics and Space Administration (NASA)
      scale: 0 = not at all … 100 = very strongly
      give:  mean of the 0-100 slider (1 decimal)
  inst_trust_noaa_1
      How much do you trust the following institutions? — National Oceanic and Atmospheric Administration (NOAA)
      scale: 0 = not at all … 100 = very strongly
      give:  mean of the 0-100 slider (1 decimal)
  inst_trust_uni_1
      How much do you trust the following institutions? — Universities and colleges
      scale: 0 = not at all … 100 = very strongly
      give:  mean of the 0-100 slider (1 decimal)
  inst_trust_gov_1
      How much do you trust the following institutions? — Federal government
      scale: 0 = not at all … 100 = very strongly
      give:  mean of the 0-100 slider (1 decimal)
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__inst_trust_mean__education__c01.json
...
```json
{
  "task_id": "F2r2__inst_trust_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C01>",
  "values": {
    "L1": {"inst_trust_epa_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "inst_trust_nasa_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"inst_trust_epa_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "inst_trust_nasa_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
