# BLIND PREDICTION TASK — F3r2__trust_multidimensional__education__c03
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__trust_multidimensional__education__c03.json
...
```json
{
  "task_id": "F3r2__trust_multidimensional__education__c03",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C08>",
  "control": {
    "L1": {"trust_transparent_1": 62.5, "trust_attention_1": 62.5},
    "L2": {"trust_transparent_1": 62.5, "trust_attention_1": 62.5},
    ...
  },
  "shifts": {
    "L1": {"trust_transparent_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "trust_attention_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    "L2": {"trust_transparent_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "trust_attention_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
