# BLIND PREDICTION TASK — F2r2__policy_specific_mean__education__c02
...
2 of the 7 items behind the scored outcome `policy_specific_mean`. Predict
each one separately: they are
asked as separate survey questions.

  policy_specific_6_1
      How much do you support or oppose: — Investing more in green jobs and businesses
      scale: 0 = Strongly oppose … 100 = Strongly support
      give:  mean of the 0-100 slider (1 decimal)
  policy_specific_7_1
      How much do you support or oppose: — Introducing laws to keep waterways and oceans clean
      scale: 0 = Strongly oppose … 100 = Strongly support
      give:  mean of the 0-100 slider (1 decimal)

(This is part 2 of 2 for this outcome and group set. The other items are asked
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__policy_specific_mean__education__c02.json
...
```json
{
  "task_id": "F2r2__policy_specific_mean__education__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C15>",
  "values": {
    "L1": {"policy_specific_6_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "policy_specific_7_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"policy_specific_6_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "policy_specific_7_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
...
* `read_check` — the first four words of the C15 text, copied exactly from the
...
When the file is written, reply with only the number of values it holds (204).
