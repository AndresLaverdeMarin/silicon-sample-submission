# BLIND PREDICTION TASK — F1r1__trust_multidimensional__education__c03
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r1__trust_multidimensional__education__c03.json
...
```json
{
  "task_id": "F1r1__trust_multidimensional__education__c03",
