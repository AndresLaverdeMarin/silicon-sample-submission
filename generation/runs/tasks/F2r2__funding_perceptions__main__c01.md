# BLIND PREDICTION TASK — F2r2__funding_perceptions__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__funding_perceptions__main__c01.json
...
```json
{
  "task_id": "F2r2__funding_perceptions__main__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C15>",
  "values": {
    "G0": {"funding_5": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
