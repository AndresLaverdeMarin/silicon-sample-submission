# BLIND PREDICTION TASK — F2r1__behavior_mean__income__c01
...
All 6 items behind the scored outcome `behavior_mean`. Predict each one
separately: they are
asked as separate survey questions.
  ...
  individual_talk_1
      ...
      give:  mean of the 0-100 slider (1 decimal)
  individual_donate_1
      How likely are you to engage in the following in the next 12 months? — Donate to an environmental NGO
      scale: 0 = Not likely at all … 100 = Extremely likely
      give:  mean of the 0-100 slider (1 decimal)
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__behavior_mean__income__c01.json
...
```json
{
  "task_id": "F2r1__behavior_mean__income__c01",
