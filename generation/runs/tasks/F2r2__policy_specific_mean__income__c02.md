# BLIND PREDICTION TASK — F2r2__policy_specific_mean__income__c02
...
1 of the 7 items behind the scored outcome `policy_specific_mean`. Predict
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__policy_specific_mean__income__c02.json
...
```json
{
  "task_id": "F2r2__policy_specific_mean__income__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C01>",
  "values": {
    "L1": {"policy_specific_7_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"policy_specific_7_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
