# BLIND PREDICTION TASK — F1r2__inst_trust_mean__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r2__inst_trust_mean__education__c01.json
...
```json
{
  "task_id": "F1r2__inst_trust_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C05>",
  "values": {
    "L1": {"inst_trust_epa_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}, "inst_trust_nasa_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    "L2": {"inst_trust_epa_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}, "inst_trust_nasa_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    ...
  }
}
```
