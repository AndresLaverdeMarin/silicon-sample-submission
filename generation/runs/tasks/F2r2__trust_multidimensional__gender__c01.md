# BLIND PREDICTION TASK — F2r2__trust_multidimensional__gender__c01
...
10 of the 12 items behind the scored outcome `trust_multidimensional`. Predict
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__trust_multidimensional__gender__c01.json
...
```json
{
  "task_id": "F2r2__trust_multidimensional__gender__c01",
