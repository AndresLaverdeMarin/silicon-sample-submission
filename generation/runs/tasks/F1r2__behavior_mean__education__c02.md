# BLIND PREDICTION TASK — F1r2__behavior_mean__education__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r2__behavior_mean__education__c02.json
...
```json
{
  "task_id": "F1r2__behavior_mean__education__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C12>",
  "values": {
    "L1": {"individual_donate_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    "L2": {"individual_donate_1": {"C00": 62.5, "C01": 62.5, "C02": 62.5, ...}},
    ...
  }
}
```
