# BLIND PREDICTION TASK — F2r2__concern_mean__education__c01
...
All 3 items behind the scored outcome `concern_mean`. Predict each one
separately: they are
asked as separate survey questions.

  concern_1_1
      How concerned are you about climate change?
      scale: 0 = Not at all … 100 = Extremely
  ...
  concern_3_1
      ...
      scale: 0 = The least important issue … 100 = The most important issue
      give:  mean of the 0-100 slider (1 decimal)
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__concern_mean__education__c01.json
...
```json
{
  "task_id": "F2r2__concern_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C15>",
  "values": {
    "L1": {"concern_1_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "concern_2_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"concern_1_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "concern_2_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
...
When the file is written, reply with only the number of values it holds (306).
