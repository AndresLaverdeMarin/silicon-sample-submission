# BLIND PREDICTION TASK — F3r1__inst_trust_mean__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r1__inst_trust_mean__education__c01.json
...
```json
{
  "task_id": "F3r1__inst_trust_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C07>",
  "control": {
    "L1": {"inst_trust_epa_1": 62.5, "inst_trust_nasa_1": 62.5},
    "L2": {"inst_trust_epa_1": 62.5, "inst_trust_nasa_1": 62.5},
    ...
  },
  "shifts": {
    "L1": {"inst_trust_epa_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "inst_trust_nasa_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    "L2": {"inst_trust_epa_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "inst_trust_nasa_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
