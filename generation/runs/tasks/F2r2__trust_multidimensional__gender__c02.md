# BLIND PREDICTION TASK — F2r2__trust_multidimensional__gender__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__trust_multidimensional__gender__c02.json
...
```json
{
  "task_id": "F2r2__trust_multidimensional__gender__c02",
