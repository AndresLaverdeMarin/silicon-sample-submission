# BLIND PREDICTION TASK — F1r2__newsletter_signup__party__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F1r2__newsletter_signup__party__c01.json
...
```json
{
  "task_id": "F1r2__newsletter_signup__party__c01",
