# BLIND PREDICTION TASK — F2r1__newsletter_signup__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__newsletter_signup__main__c01.json
...
```json
{
  "task_id": "F2r1__newsletter_signup__main__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C12>",
  "values": {
    "G0": {"newsletter": {"C00": 12.5, "C16": 12.5, "C15": 12.5, ...}},
    ...
  }
}
```
