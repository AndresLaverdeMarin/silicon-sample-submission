# BLIND PREDICTION TASK — F3r1__behavior_mean__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r1__behavior_mean__education__c01.json
...
```json
{
  "task_id": "F3r1__behavior_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C13>",
  "control": {
    "L1": {"individual_meat_1": 62.5, "individual_transport_1": 62.5},
    "L2": {"individual_meat_1": 62.5, "individual_transport_1": 62.5},
    ...
  },
  "shifts": {
    "L1": {"individual_meat_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "individual_transport_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    "L2": {"individual_meat_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "individual_transport_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
...
* `read_check` — the first four words of the C13 text, copied exactly from the
