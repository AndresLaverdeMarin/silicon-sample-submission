# BLIND PREDICTION TASK — F2r1__trust_multidimensional__education__c02
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__trust_multidimensional__education__c02.json
...
```json
{
  "task_id": "F2r1__trust_multidimensional__education__c02",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C05>",
  "values": {
    "L1": {"trust_sincere_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_concerned_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    "L2": {"trust_sincere_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}, "trust_concerned_1": {"C00": 62.5, "C16": 62.5, "C15": 62.5, ...}},
    ...
  }
}
```
...
* `read_check` — the first four words of the C05 text, copied exactly from the
