# BLIND PREDICTION TASK — F2r1__newsletter_signup__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r1__newsletter_signup__education__c01.json
...
```json
{
  "task_id": "F2r1__newsletter_signup__education__c01",
