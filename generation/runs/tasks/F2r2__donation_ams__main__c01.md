# BLIND PREDICTION TASK — F2r2__donation_ams__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F2r2__donation_ams__main__c01.json
...
```json
{
  "task_id": "F2r2__donation_ams__main__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C11>",
  "values": {
    "G0": {"donation": {"C00": 2.50, "C16": 2.50, "C15": 2.50, ...}},
    ...
  }
}
```
