# BLIND PREDICTION TASK — F3r2__trust_multidimensional__main__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__trust_multidimensional__main__c01.json
...
```json
{
  "task_id": "F3r2__trust_multidimensional__main__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C15>",
  "control": {
    "G0": {"trust_competent_1": 62.5, "trust_intelligent_1": 62.5},
    ...
  },
  "shifts": {
    "G0": {"trust_competent_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}, "trust_intelligent_1": {"C05": 1.4, "C12": 1.4, "C16": 1.4, ...}},
    ...
  }
}
```
