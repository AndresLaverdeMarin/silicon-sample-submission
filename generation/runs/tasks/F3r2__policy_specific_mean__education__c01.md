# BLIND PREDICTION TASK — F3r2__policy_specific_mean__education__c01
...
Write one JSON object of exactly this shape, and nothing else, to:
  ...
  generation/runs/raw/F3r2__policy_specific_mean__education__c01.json
...
```json
{
  "task_id": "F3r2__policy_specific_mean__education__c01",
  "model_id": "<your exact model id>",
  "read_check": "<first four words of C10>",
  "control": {
...
* `read_check` — the first four words of the C10 text, copied exactly from the
